...
import static com.example.administrator756.finaldictionary.R.layout.activity_main;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void toast(String inp){
        Toast toast = Toast.makeText(MainActivity.this, inp, Toast.LENGTH_SHORT) ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fav_b.setOnLongClickListener(new View.OnLongClickListener(){
            ...
            public boolean onLongClick(View view){
                Intent intent = new Intent(MainActivity.this, favourites_sc.class) ;
        ...
        rec_b.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent intent = new Intent(MainActivity.this, recent_sc.class) ;
                startActivity(intent);
            }
        } );
        ...
        help_b.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent intent = new Intent(MainActivity.this, help_sc.class) ;
                startActivity(intent);
            }
        } );
    ...
    public void change_lan(){
        if(l == 0){
            l = 1 ;
            lan_b.setBackgroundResource(R.drawable.alpha_t);
            toast("Please Change Keypad to Telugu") ;
            autocomplete();
         }
        else if(l == 1) {
            l = 2;
            lan_b.setBackgroundResource(R.drawable.alpha_h);
            toast("Please Change Keypad to Hindi") ;
            autocomplete();
         }
        else {
            l = 0 ;
            lan_b.setBackgroundResource(R.drawable.alpha_e);
            toast("Please Change Keypad to English") ;
            autocomplete();
        }
    }
